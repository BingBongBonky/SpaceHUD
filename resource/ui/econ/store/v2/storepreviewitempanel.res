"Resource/UI/StorePreviewItemPanel.res"
{
	...
	{	
		...
		// Background for the player model
		// & item preview panels
		"PreviewViewportBg"
		{
			"ControlName"					"EditablePanel"
		...
		// Scrollable editable panel for 
		// right-hand side of preview, 
		// for all text details
	...
	"ItemIcon1"
	{
		...
		"tall"								"20"
		"visible"							"1"
		"panel_bgcolor" 					"20 27 40 255"		// MenuDefault
		"panel_bgcolor_mouseover" 			"20 60 100 255"		// HighlightColor
		"image_indent"						"0"
		"PaintBackgroundType"				"0"
	...
	"IconsMoveLeftButton"
	{
		...
		"armedFgColor_override"				"HighlightColor"
	...
	//---
	// Hack - put these two labels 
	// off-screen, since we have cycle text 
	// to take the place of both of them
	...
	"CloseButton"
	{
		...
		"sound_released"					"UI/buttonclickrelease.wav"
		"Command"							"closex"	
		// Intentionally using "closex" 
		// instead of "close" for stats
